...
// Generate dynamic timeline from RAG model
async function generateQueryResponse(chatElement) {
...
async function readURLData(url) {
...
const handleChat = () => {
    ...
    //    generateResponse(incomingChatLi);
        generateQueryResponse(incomingChatLi);
    }, 600);
}
